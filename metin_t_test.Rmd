...
Tanım olarak t-testi, iki grubun ortamaları arasında anlamlı bir fark olup olmadığını test etmek için kulanılabilir.
...
İstersek yoğunluk grafiğiyle de bunu görselleştirebiliriz. Burada iki dağımı alıp, bir veri çerçevesinin içersine yerleştirdik, ve dagilim1 ve dagilim2 olarak iki farklı faktör verisi oluşturduk:
...
Yapmaya çalıştığımız ise doğrudan sıfır hipotezini reddedmeye çalışmak. Bu sayede alternatif hipotezi kabul edebiliriz.
...
Bunun anlamı aslında şu: 0.0001 hata olaslığı durumunda, bu iki dağılımın ortalamaları anlamlı bir şekilde farklı! Yani sıfır hipotezini reddedip, alternatif hipotezi kabul ediyoruz!
...
```
Dikkat ederseniz, bu dağılımların ortalamalrı üst üste bindi. Peki t-testi uygularsak nasıl bir sonuç elde edeceğiz?
