...
Matrisler (@sec-matrisler) ve veri çerçeveleri (@sec-veri-cerceveleri) derslerinde gördüğümüz veri yapıları, belirli bir düzende oluşturaliliyordu. Yani bu veri yapılarının, belirli kısıtları bulunmaktadydı. Mesela bir grup vektörden veri çerçevesi oluşturmak istiyorsanız, vektörlerin uzunluklarının aynı olması gerkeiyordu.
...
Hayali veri setimizi şuraya bırakalım yine (@tbl-bitkiler).
