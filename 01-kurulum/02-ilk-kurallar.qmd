...
Bu sayfada, önceki yıllarda karşılaşılan önemli sorunları özetlemeye çalıştım. Bu noktalara dikkat ederseniz öğrenme sürecini daha verimli geçirebilirsiniz.
...
Bu yüzde ders kapsamında yapacağınız **kodlamaları** sadece ASCII karakter seti üzerinden gerçekleştirin. Aslında çok kolay, aşağıdaki kutucukta bulunan harfler - ve kendi alfabenizdeki İngilizce dışındaki karakterler - YASAK!
