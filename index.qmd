...
Eğer bu dersi ilk defa alıyorsanız, ilk olarak **Kurulum** kısmını inceleyerek @sec-sistem kısmında R ve Rstüdyo programlarının kurulumu hakkında bilgi alabilirsiniz. Ardından @sec-onemli kısmında bulunan dikkat edilmesi gereken noktaları inceleyebilirsiniz. Daha sonra @sec-klasor kısmında ise, kullandığınız işletim sistemindeki klasör organizasyonu hakkında fikir alabilirsiniz.
