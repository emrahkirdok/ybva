...
Bu internet sitesi aslında 2020 - 2022 yılında verilen dersler süresince oluşturulan kaynakları temel almaktadır. Değişiklik.
...
@sec-sistem R ve Rstüdyo programlarının kurulumu hakkında bilgileri içermektedir. Ardından @sec-onemli ise, R ve RStudio ile çalışırken dikkat edilmesi gereken noktaları içermektedir. Burada yazan küçük ayıntılara dikkat ederseniz, gereksiz bir şekilde yaşayacağınız vakit kaybının önüne geçebilirsiniz. @sec-ilk-adimlar, R ve Rstudio programları ile çalışmaya başlamanız için gerekli bilgileri anlatmaktdır. @sec-klasor'de, kullandığınız işletim sistemindeki klasör organizasyonu hakkında fikir alabilirsiniz.
