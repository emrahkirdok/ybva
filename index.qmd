...
Ders sürekli güncellenmektedir. Dolayısıyla takip etmeniz gereklidir.
...
Biyoteknoloji Bölümü Discord sunucusu temel haberleşme noktamız olacaktır. Derslerle ilgili bütün soruları orada cevaplayacağım. Dolayısıyla platforma üye olmanızı tavsiye ederim.
...
Eğer bu dersi ilk defa alıyorsanız, ilk olarak **Derse Hazırlık** kısmını inceleyerek kullanılacak sistemlerin kurulumu hakkında bilgi alabilir. @sec-sistem bölümünde, R ve Rstüdyo programlarının kurulumu hakkında bilgi alabilirsiniz. Ardından @sec-onemli bölümünde ise, dikkat edilmesi gereken noktaları inceleyebilirsiniz. @sec-klasor'de ise, kullandığınız işletim sistemindeki klasör organizasyonu hakkında fikir alabilirsiniz.
