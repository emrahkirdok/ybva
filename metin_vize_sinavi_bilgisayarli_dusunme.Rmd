...
En kolayı, yeni bir proje klasörü oluşturmanız ve bu veriyi de o proje klasörü içerisine yüklemeniz olacaktır.
...
```{r}
abalone_veri <- read.table("data/abalone.txt", header = T)
