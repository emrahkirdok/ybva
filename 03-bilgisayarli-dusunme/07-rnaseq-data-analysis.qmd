...
Örnek metaverisine baktığımızda, örneklerin sahip oldukları metaveri bilgilerini görebiliriz. Burada iki tane koşul bulunmakta: `kontrol` ve `uygulama`
...
İlk olarak birinci geni inceleyelim. Acaba bu gen anlatımında anlamlı bir farklılık var mı?
...
Evet, bu gen anlamlı bir şekilde değişmiş. Şimdi de bu genin grafiğine bakalım:
