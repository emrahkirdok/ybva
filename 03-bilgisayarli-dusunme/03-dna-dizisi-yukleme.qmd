...
Daha sonra R oturumunuza eklemelisniz:
...
Bu işlemin sonucunda elimize bir liste geçti. İsterseniz `names` fonksiyonu ile bu listedeki dizilerin fasta isimlerini inceleyelim:
...
Artık bir fasta dizisini, R içerisine aktarmayı biliyorsunuz. Tebrikler.